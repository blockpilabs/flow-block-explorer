...
function initTriggers(elem) {
  ...
  const triggers = createElement('div', { className: 'resize-triggers' });
  const expand = createElement('div', { className: 'resize-expand-trigger' });
  const expandChild = createElement('div');
  const contract = createElement('div', { className: 'resize-contract-trigger' });
