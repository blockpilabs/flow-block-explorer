...
<script>
import TitanRender from './Render';
// import forced from './forced.js';
export default {
  name: 'TitanColumn',

  components: { TitanRender },
  inheritAttrs: false,
  props: {
    column: {
      type: Object,
