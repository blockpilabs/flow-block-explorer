...
// TitanSelect的默认参数，可通过传入props.config进行覆盖
const DefaultConfig = {
  ...
  computed: {
    ...
    calcRemote() {
      ...
      if (this.remote === undefined) {
        return this.$titanSelect.remote;
      }
      return this.remote;
    },
    ...
    calcFilterable() {
      ...
      if (this.filterable === undefined) {
        return this.$titanSelect.filterable;
      }
    ...
    calcPopperAppendToBody() {
      if (this.popperAppendToBody === undefined) {
        return this.$titanSelect.popperAppendToBody;
      }
